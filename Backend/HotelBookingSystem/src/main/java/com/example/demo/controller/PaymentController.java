...
//        System.out.println("Received a request to add payment for order ID: " + bookingId + " and customer ID: " + userId);
//        
//        Payment addedPayment = PaymentServiceImplementation.addPayment(payment, bookingId, userId);
//        
